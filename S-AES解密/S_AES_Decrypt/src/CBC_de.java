...
public class CBC_de extends JFrame {
	...
	public CBC_de() {
		...
		lblNewLabel.setBounds(24, 26, 125, 45);
		...
		cipherText.setBounds(193, 106, 288, 21);
		contentPane.add(cipherText);
		cipherText.setColumns(10);
		
		JLabel lblNewLabel_1_1 = new JLabel("初始向量：");
		lblNewLabel_1_1.setFont(new Font("宋体", Font.BOLD, 20));
		lblNewLabel_1_1.setBounds(72, 156, 111, 24);
		contentPane.add(lblNewLabel_1_1);
		
		vectorText = new JTextField();
		vectorText.setText("1000010001010110");
		vectorText.setEditable(false);
		vectorText.setColumns(10);
		vectorText.setBounds(193, 156, 288, 21);
		contentPane.add(vectorText);
		...
		btnNewButton.setBounds(298, 210, 135, 33);
		...
		PlainText.setBounds(193, 270, 288, 21);
	...
	//异或
		...
		//初始向量
		public static String vector="1000010001010110";
		//密钥扩展-g函数
        ...
        public static void CBC_de() {
        	mKey=vector;
        	cipher1=cipherText.getText().substring(0, 16);
        	cipher2=cipherText.getText().substring(16);
        	//round1
        	cipher=cipher1;
        	getKey();
        	decrypt();
        	plain1=XOR(plainText,vector);
        	//round2
        	cipher=cipher2;
        	getKey();
        	decrypt();
        	plain2=XOR(plainText,vector);
        	//结果显示
        	PlainText.setText(plain1+plain2);
        	}
        //测试用例
		//密文：00000001101100101111101011101111
		//明文：0110101110100011
