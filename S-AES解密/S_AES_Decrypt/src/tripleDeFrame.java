...
public class tripleDeFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					tripleDeFrame frame = new tripleDeFrame();
	...
	public tripleDeFrame() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(KEY.length()!=48 ||CIPHER.length()!=16) {
					...
					KEY3=KEY.substring(32, 48);
					for(int i=3;i>0;i--) {
					getKey(i);
					CIPHER=decrypt();
					}
				plainText1.setText(CIPHER);
				}
			}
		});
		...
		btnNewButton.setBounds(176, 220, 126, 33);
		contentPane.add(btnNewButton);
		
		JLabel lblNewLabel_1_2 = new JLabel("明文：");
		lblNewLabel_1_2.setFont(new Font("宋体", Font.BOLD, 20));
		lblNewLabel_1_2.setBounds(103, 269, 62, 24);
		contentPane.add(lblNewLabel_1_2);
		
		plainText1 = new JTextField();
		plainText1.setEditable(false);
		plainText1.setColumns(10);
		plainText1.setBounds(175, 273, 175, 21);
		contentPane.add(plainText1);
	}
	//48bits密钥处理
	public static String KEY1=new String();
	public static String KEY2=new String();
	public static String KEY3=new String();
	//每轮参与运算的密文
	...
	//异或
			...
			public static void getKey(int n) {
				//轮次解密
				if(n==1) {
					mKey=KEY1;
				}else if(n==2) {
	        ...
	        //测试举例
	        //三重密钥：011011010101011100101101010101110010110101010101
	        //密文：0011110000111011
	        //第一轮：密钥：0010110101010101
	      	//密文：0011110000111011
	      	//明文：0110101110100011
	        //第二轮：密文：0110101110100011
	        //密钥：0010110101010111
	        //明文：1101111101111110
	        //第三轮：密文：1101111101111110
	        //密钥：0110110101010111
	        //明文：1100110001000110
}
