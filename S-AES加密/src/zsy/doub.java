...
public class doub extends JFrame{
    ...
    public doub() {
        ...
        JLabel main = new JLabel("请输入密钥(32 bits)：");
...
//        smallText.setEditable(false);
        ...
        JButton decode = new JButton("双重加密");
        decode.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                System.out.println(up21);
                System.out.println(down21);
                //行移位
                ...
                enkey(t2);
                String second = XOR(first,t2);
                String sup1 = second.substring(0,8);
                String sdown1 = second.substring(8,16);
