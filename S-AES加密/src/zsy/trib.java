...
public class trib extends JFrame{
    ...
    public trib() {
        ...
        JLabel main = new JLabel("请输入密钥(48 bits)：");
...
//        smallText.setEditable(false);
        ...
        JButton decode = new JButton("三重加密");
        decode.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                String t1 = mKey.substring(0,16);
                enkey(t1);
                String st1 = XOR(st, t1);
                ...
                String first = XOR(st5,w2);
                //双重加密
                String t2 = mKey.substring(16,32);
                enkey(t2);
                String ori = XOR(first,t2);
                String sup1 = ori.substring(0,8);
                String sdown1 = ori.substring(8,16);
                String sup11 = S_Selected(sup1);
                String sdown11 = S_Selected(sdown1);
                //行移位
                String sst2 = sup11.substring(0,4)+sdown11.substring(4,8)+sdown11.substring(0,4)+sup11.substring(4,8);
                String sst3 = colmix(sst2);
                String sst4 = XOR(sst3, w1);
                String sup2 = sst4.substring(0,8);
                String sdown2 = sst4.substring(8,16);
                String sup21 = S_Selected(sup2);
                String sdown21 = S_Selected(sdown2);
                //行移位
                String sst5 = sup21.substring(0,4)+sdown21.substring(4,8)+sdown21.substring(0,4)+sup21.substring(4,8);
                String second = XOR(sst5,w2);
                //三重加密
                String t3 = mKey.substring(32,48);
                enkey(t3);
                String tori = XOR(second,t2);
                String tup1 = tori.substring(0,8);
                String tdown1 = tori.substring(8,16);
                String tup11 = S_Selected(tup1);
                String tdown11 = S_Selected(tdown1);
                //行移位
                String tst2 = tup11.substring(0,4)+tdown11.substring(4,8)+tdown11.substring(0,4)+tup11.substring(4,8);
                String tst3 = colmix(tst2);
                String tst4 = XOR(tst3, w1);
                String tup2 = tst4.substring(0,8);
                String tdown2 = tst4.substring(8,16);
                String tup21 = S_Selected(tup2);
                String tdown21 = S_Selected(tdown2);
                //行移位
                String tst5 = tup21.substring(0,4)+tdown21.substring(4,8)+tdown21.substring(0,4)+tup21.substring(4,8);
                String smText = XOR(tst5,w2);
                smallText.setText(smText);
            }
        });
        decode.setFont(new Font("宋体", Font.PLAIN, 16));
        decode.setBounds(305, 75, 100, 37);
        panel.add(decode);
